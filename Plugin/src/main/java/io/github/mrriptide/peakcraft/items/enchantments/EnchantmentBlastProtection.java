...
public class EnchantmentBlastProtection extends EnchantmentData {

    public EnchantmentBlastProtection() {
        super("blast_protection", "Blast Protection", 5);
    }
    ...
    public void onAction(Action action, int level) {
        ((DamagedAction) action).getDamage().getProtection(Damage.DamageType.EXPLOSION).addMulti(0.04*level);
    }
}
