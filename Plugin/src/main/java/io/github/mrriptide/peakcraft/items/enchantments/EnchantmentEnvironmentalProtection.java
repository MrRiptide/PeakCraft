...
public class EnchantmentEnvironmentalProtection extends EnchantmentData {
    public EnchantmentEnvironmentalProtection() {
        super("environmental_protection", "Environmental Protection", 5);
    }
    ...
    public void onAction(Action action, int level) {
        ((DamagedAction) action).getDamage().getProtection(Damage.DamageType.ENVIRONMENTAL).addMulti(0.04*level);
    }
}
